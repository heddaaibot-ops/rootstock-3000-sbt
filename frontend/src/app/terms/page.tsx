      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto bg-rsk-offwhite border-3 border-rsk-border-dark p-8 md:p-12">
            <div className="mb-4">
              <h1 className="inline-block bg-rsk-lime text-rsk-text-dark text-4xl font-bold px-8 py-4 uppercase">
            ...
            <div className="prose max-w-none space-y-6 text-rsk-text-dark">
              ...
              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">1. 活动</h2>

              <h3 className="text-xl font-semibold text-rsk-text-dark mt-6 mb-3">1.1</h3>
              ...
              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">2. 活动期限</h2>
              <p>
                活动将于 2026 年 3 月 22 日开始，持续至 2026 年 3 月 31 日 UTC 时间 23:59（以下简称"期限"），在指定活动网站上进行。
              </p>

              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">3. 奖励与奖品</h2>
              ...
              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">4. 责任</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">5. 欺诈</h2>
              ...
              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">6. 活动变更</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-rsk-orange mt-8 mb-4">7. 其他</h2>
              <p>
