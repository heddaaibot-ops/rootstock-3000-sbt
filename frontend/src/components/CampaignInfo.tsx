      ...
      <div className="bg-rsk-gray/50 border border-rsk-orange/20 rounded-2xl p-8 mb-8">
        ...
        <div className="space-y-4 text-gray-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-rsk-light mb-1">{t('campaign.step1.title')}</p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-rsk-light mb-1">{t('campaign.step2.title')}</p>
              <p className="text-sm text-gray-400">{t('campaign.step2.description')}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-rsk-light mb-1">{t('campaign.step3.title')}</p>
              <p className="text-sm text-gray-400">{t('campaign.step3.description')}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-rsk-light mb-1">{t('campaign.step4.title')}</p>
              <p className="text-sm text-gray-400">{t('campaign.step4.description')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-rsk-orange/10 to-orange-400/10 border border-rsk-orange/30 rounded-2xl p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-400">{t('campaign.rewards.usdtDescription')}</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-rsk-orange mb-2">{t('campaign.rewards.merch')}</div>
            <div className="text-sm text-gray-400">{t('campaign.rewards.merchDescription')}</div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 border-l-4 border-rsk-orange/30 pl-6 pb-2">
              <p className="font-semibold text-rsk-light">{t('campaign.timeline.launch.title')}</p>
              <p className="text-sm text-gray-400">{t('campaign.timeline.launch.description')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 border-l-4 border-rsk-orange pl-6 pb-2">
              <p className="font-semibold text-rsk-light">{t('campaign.timeline.milestone.title')}</p>
              <p className="text-sm text-gray-400">{t('campaign.timeline.milestone.description')}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 border-l-4 border-rsk-orange/30 pl-6">
              <p className="font-semibold text-rsk-light">{t('campaign.timeline.deadline.title')}</p>
              <p className="text-sm text-gray-400">{t('campaign.timeline.deadline.description')}</p>
            </div>
          </div>
        </div>
      </div>
